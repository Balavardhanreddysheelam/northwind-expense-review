Subject: Northwind Logistics Expense Pre-Review Case Study

Hi GreenGrowth CPAs Hiring Team,
...
The public repository excludes the supplied evaluation package. The deployed demo uses synthetic data, and held-out receipts can be uploaded through the browser.
